...
class VagaList extends TPage
{
    ...
    public function __construct()
    {
       ...
       $pessoa_id->setSize('100%');
        ...
        $this->form->addActionLink('Nova Vaga', new TAction(['VagaForm', 'onEdit']), 'fa:plus green');
        ...
        $this->datagrid->addAction($action2 ,'Ativar / Inativar', 'fa:power-off orange');
    ...
    public function onTurnOnOff($param)
    {
        ...
        {
            TTransaction::open('conecta');
            $srv = Vaga::find($param['id']);
            
            if ($srv instanceof Vaga)
            {
