...
class TesteList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('Teste');   // defines the active record
        ...
        $this->form->setFormTitle('<b>Lista de Testes</b>');
        ...
        $this->form->addActionLink('Cadastrar Novo', new TAction(['TesteForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $column_nome = new TDataGridColumn('nome', 'Teste', 'left');
        ...
        $action1 = new TDataGridAction(['TesteForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onTurnOnOff($param)
    {
        try
        {
            ...
            $srv = Teste::find($param['id']);
            
            if ($srv instanceof Teste)
            {
