<?php
/**
 * PmobVendedoras Active Record
 * @author  Anderson Souza
 */
class PmobVendedoras extends TRecord
{
    const TABLENAME = 'pmob_vendedoras';
    const PRIMARYKEY= 'id';
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('pergunta11');
        parent::addAttribute('pergunta12');
        parent::addAttribute('pergunta13');
        parent::addAttribute('pergunta14');
        parent::addAttribute('pergunta15');
        parent::addAttribute('pergunta16');
        parent::addAttribute('pergunta17');
        parent::addAttribute('pergunta18');
        parent::addAttribute('pergunta19');
        parent::addAttribute('pergunta20');
