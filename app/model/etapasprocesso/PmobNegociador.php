<?php
/**
 * PmobNegociador Active Record
 * @author  Anderson Souza
 */
class PmobNegociador extends TRecord
{
    const TABLENAME = 'pmob_negociador';
    const PRIMARYKEY= 'id';
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('flag_p26');
        parent::addAttribute('flag_p27');
        parent::addAttribute('flag_p28');
        parent::addAttribute('flag_p29');
        parent::addAttribute('flag_p30');
